...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/munia/last_courier_keycloak/courier/newenv'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/munia/last_courier_keycloak/courier/newenv/bin/deactivate.nu'
